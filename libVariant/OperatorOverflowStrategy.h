...
namespace libVariant
{
  ...
  // Class Declarations
  //------------------------
  class LIBVARIANT_API OperatorOverflowStrategy : public virtual IBaseOperatorStrategy
  {
  public:
    //----------------------
    // constructors methods
    //----------------------
    OperatorOverflowStrategy(Variant * iVariantObj);
    virtual ~OperatorOverflowStrategy();
